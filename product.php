...
<body>
    ...
    <header class="header header-size-s">
        <div class="header-text">
            <div class="header-t1">商品與服務</div>
            <div class="header-t2">Prodcut & Service</div>
        </div>
    ...
    <section class="news article clear-fix">
        <div class="categories-section">
            ...
            ?>
             <?php while($row=mysql_fetch_array($rs)){ ?>
            <div class="category">
              <img src="upload/newsclass/<?php echo $row['img'] ?>">
              <div class="mask"></div>
              <h2 class="title"><?php echo $row['title'] ?></h2>
              <p class="content"><?php echo $row['brief'] ?></p>
              <p class="more"><a href="productlist.html?no=<?php echo $row['no'] ?>">更多</a></p> 
            </div>
            <?php }?>            
        </div>
    </section>
